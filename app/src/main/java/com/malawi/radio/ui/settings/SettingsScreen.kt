...
private fun HelpContent(appName: String) {
    ...
    BulletWithBoldLead("No station playing", "If none of the stations in the list are playing, make sure your network is connected and internet is active, and check whether other apps are connected. You may also try restarting the app and if that doesn't work, try restarting your device. Make sure also that you have installed the latest version of the app. If the problem persists for up to a week, kindly email $SUPPORT_EMAIL to notify us. Remember to mention $appName in your email message.")
    BulletWithBoldLead("A single station not playing", "If the station was previously playing and now has stopped while other stations are still playing, try connecting again later or restarting the app. If the problem persists for up to a month it means the station may be unavailable or discontinued so kindly email $SUPPORT_EMAIL to notify us. Remember to mention $appName in your email message.")
    BulletWithBoldLead("Incorrect station details", "If a listed station shows incorrect details or a wrong name, kindly contact us via email at $SUPPORT_EMAIL to notify us. Remember to mention $appName in your email message.")
